...
public class ModBlockEntities
{
	...
	public static final RegistryObject<BlockEntityType<ModHangingSignBlockEntity>> LOST_TF_HANGING_SIGN = BLOCK_ENTITIES.register("lost_tf_hanging_sign", () -> BlockEntityType.Builder.of(ModHangingSignBlockEntity::new, ModBlocks.TOWERWOOD_HANGING_SIGN.get(), ModBlocks.TOWERWOOD_WALL_HANGING_SIGN.get()).build(null));
}
