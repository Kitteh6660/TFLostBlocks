...
public class ModBlocks
{
	...
	public static final RegistryObject<Block> LARGE_MAZESTONE_BRICKS = BLOCKS.register("large_mazestone_bricks", () -> new MazestoneBlock(Properties.copy(TFBlocks.MAZESTONE_BRICK.get())));
