...
public class ModBlocks
{
	...
	public static final RegistryObject<Block> THORN_BUTTON = BLOCKS.register("thorn_button", () -> new ButtonBlock(BlockBehaviour.Properties.of().noCollission().strength(0.5F).sound(SoundType.WOOD), ModWoodType.THORN_SET, 30, true));
	public static final RegistryObject<Block> THORN_PRESSURE_PLATE = BLOCKS.register("thorn_pressure_plate", () -> new PressurePlateBlock(PressurePlateBlock.Sensitivity.EVERYTHING, BlockBehaviour.Properties.of().noCollission().strength(0.5F).sound(SoundType.WOOD), ModWoodType.THORN_SET));
	public static final RegistryObject<Block> THORN_SIGN = BLOCKS.register("thorn_sign", () -> new ModStandingSignBlock(BlockBehaviour.Properties.of().noCollission().strength(1.0F, 2000.0F).sound(SoundType.WOOD), ModWoodType.THORN_WOOD_TYPE));
	public static final RegistryObject<Block> THORN_WALL_SIGN = BLOCKS.register("thorn_wall_sign", () -> new ModWallSignBlock(BlockBehaviour.Properties.of().noCollission().strength(1.0F, 2000.0F).sound(SoundType.WOOD), ModWoodType.THORN_WOOD_TYPE));
	public static final RegistryObject<Block> THORN_HANGING_SIGN = BLOCKS.register("thorn_hanging_sign", () -> new ModCeilingHangingSignBlock(BlockBehaviour.Properties.of().noCollission().strength(1.0F, 2000.0F).sound(SoundType.WOOD), ModWoodType.THORN_WOOD_TYPE));
	public static final RegistryObject<Block> THORN_WALL_HANGING_SIGN = BLOCKS.register("thorn_wall_hanging_sign", () -> new ModWallHangingSignBlock(BlockBehaviour.Properties.of().noCollission().strength(1.0F, 2000.0F).sound(SoundType.WOOD), ModWoodType.THORN_WOOD_TYPE));
