...
public class ModBlocks
{
	...
	public static final RegistryObject<Block> TOWERWOOD_HANGING_SIGN = BLOCKS.register("towerwood_hanging_sign", () -> new ModCeilingHangingSignBlock(BlockBehaviour.Properties.of(Material.WOOD).noCollission().strength(1.0F).sound(SoundType.WOOD), ModWoodType.TOWERWOOD_WOOD_TYPE));
	public static final RegistryObject<Block> TOWERWOOD_WALL_HANGING_SIGN = BLOCKS.register("towerwood_wall_hanging_sign", () -> new ModWallHangingSignBlock(BlockBehaviour.Properties.of(Material.WOOD).noCollission().strength(1.0F).sound(SoundType.WOOD), ModWoodType.TOWERWOOD_WOOD_TYPE));
	...
	public static final RegistryObject<Block> THORN_FENCE_GATE = BLOCKS.register("thorn_fence_gate", () -> new FenceGateBlock(Properties.copy(STRIPPED_THORN_BLOCK.get()), SoundEvents.FENCE_GATE_CLOSE, SoundEvents.FENCE_GATE_OPEN));
	public static final RegistryObject<Block> THORN_DOOR = BLOCKS.register("thorn_door", () -> new DoorBlock(Properties.copy(STRIPPED_THORN_BLOCK.get()), ModWoodType.THORN_SET));
	public static final RegistryObject<Block> THORN_TRAPDOOR = BLOCKS.register("thorn_trapdoor", () -> new TrapDoorBlock(Properties.copy(STRIPPED_THORN_BLOCK.get()), ModWoodType.THORN_SET));
	public static final RegistryObject<Block> THORN_BUTTON = BLOCKS.register("thorn_button", () -> new ButtonBlock(BlockBehaviour.Properties.of(Material.WOOD).noCollission().strength(0.5F).sound(SoundType.WOOD), ModWoodType.THORN_SET, 30, true));
	public static final RegistryObject<Block> THORN_PRESSURE_PLATE = BLOCKS.register("thorn_pressure_plate", () -> new PressurePlateBlock(PressurePlateBlock.Sensitivity.EVERYTHING, BlockBehaviour.Properties.of(Material.WOOD).noCollission().strength(0.5F).sound(SoundType.WOOD), ModWoodType.THORN_SET));
	public static final RegistryObject<Block> THORN_SIGN = BLOCKS.register("thorn_sign", () -> new ModStandingSignBlock(BlockBehaviour.Properties.of(Material.WOOD).noCollission().strength(1.0F, 2000.0F).sound(SoundType.WOOD), ModWoodType.THORN_WOOD_TYPE));
	public static final RegistryObject<Block> THORN_WALL_SIGN = BLOCKS.register("thorn_wall_sign", () -> new ModWallSignBlock(BlockBehaviour.Properties.of(Material.WOOD).noCollission().strength(1.0F, 2000.0F).sound(SoundType.WOOD), ModWoodType.THORN_WOOD_TYPE));
	public static final RegistryObject<Block> THORN_HANGING_SIGN = BLOCKS.register("thorn_hanging_sign", () -> new ModCeilingHangingSignBlock(BlockBehaviour.Properties.of(Material.WOOD).noCollission().strength(1.0F, 2000.0F).sound(SoundType.WOOD), ModWoodType.THORN_WOOD_TYPE));
	public static final RegistryObject<Block> THORN_WALL_HANGING_SIGN = BLOCKS.register("thorn_wall_hanging_sign", () -> new ModWallHangingSignBlock(BlockBehaviour.Properties.of(Material.WOOD).noCollission().strength(1.0F, 2000.0F).sound(SoundType.WOOD), ModWoodType.THORN_WOOD_TYPE));
